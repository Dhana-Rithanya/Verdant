    ...
    <div className="min-h-screen bg-[#F5F0E8] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-800">Verdant</h1>
          <p className="text-sm text-stone-500 mt-1">Sign in to your carbon tracker</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#FDFAF4] rounded-xl p-6 shadow-sm border border-stone-200 space-y-4">
          ...
          <p className="text-xs text-center text-stone-400">
            ...
            <Link to="/signup" className="text-[#6B8F5E] font-medium hover:underline">Sign up</Link>
          </p>
        </form>
      </div>
    </div>
